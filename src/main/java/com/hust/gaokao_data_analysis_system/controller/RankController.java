...
public class RankController {
    ...
    @PostMapping("/qs/list")
    public ResponseResult getAllQsRank(@RequestBody PageRequest pageRequest){
    ...
    @PostMapping("/rk/list")
    public ResponseResult getAllRkRank(@RequestBody PageRequest pageRequest){
        int currentPage = pageRequest.getCurrentPage();
        int pageSize = pageRequest.getPageSize();
        Page pg = new Page<>(currentPage, pageSize);
        Page pageRkRanks = rkService.findAll(pg);
    ...
    public ResponseResult getAllTwsRank(@RequestBody PageRequest pageRequest){
        int currentPage = pageRequest.getCurrentPage();
        int pageSize = pageRequest.getPageSize();
        Page pg = new Page<>(currentPage, pageSize);
    ...
    @PostMapping("/us/list")
    public ResponseResult getAllUsRank(@RequestBody PageRequest pageRequest){
        int currentPage = pageRequest.getCurrentPage();
        int pageSize = pageRequest.getPageSize();
        Page pg = new Page<>(currentPage, pageSize);
        Page pageUsRanks = usService.findAll(pg);
    ...
    public ResponseResult getAllWslRank(@RequestBody PageRequest pageRequest){
        int currentPage = pageRequest.getCurrentPage();
        int pageSize = pageRequest.getPageSize();
        Page pg = new Page<>(currentPage, pageSize);
        Page pageWslRanks = wslService.findAll(pg);
    ...
    public ResponseResult getAllXyhRank(@RequestBody PageRequest pageRequest){
        int currentPage = pageRequest.getCurrentPage();
        int pageSize = pageRequest.getPageSize();
        Page pg = new Page<>(currentPage, pageSize);

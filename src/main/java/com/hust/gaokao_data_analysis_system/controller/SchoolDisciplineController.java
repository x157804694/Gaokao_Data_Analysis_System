...
public class SchoolDisciplineController {
    ...
    public ResponseResult getAllSchoolDisciplineByPage(@RequestBody PageRequest pageRequest){
        ...
        Page pgSchoolDisciplineVos = schoolDisciplineService.findAll(pg);
    ...
    public ResponseResult addSchoolDiscipline(@RequestBody SchoolDiscipline addSchoolDiscipline){
        ...
        queryMap.put("school_discipline_school",addSchoolDiscipline.getSchool_discipline_school());
        queryMap.put("school_discipline_discipline",addSchoolDiscipline.getSchool_discipline_discipline());
        // 判断是否已存在这条记录
        SchoolDiscipline schoolDiscipline = schoolDisciplineService.getOne(qw.allEq(queryMap));
